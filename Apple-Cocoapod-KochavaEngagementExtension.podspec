...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of Apple-Cocoapod-KochavaEngagementExtension.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/johnbushnell/Apple-Cocoapod-KochavaEngagementExtension'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'johnbushnell' => 'jbushnell@kochava.com' }
  s.source           = { :git => 'https://github.com/johnbushnell/Apple-Cocoapod-KochavaEngagementExtension.git', :tag => s.version.to_s }
